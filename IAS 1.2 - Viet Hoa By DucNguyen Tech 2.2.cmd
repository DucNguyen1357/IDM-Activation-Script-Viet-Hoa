...
::   DucNguyen Tech
::
::   Homepages: https://github.com/DucNguyen1357/IDM-Activation-Script-Viet-Hoa
::              https://ducnguyen.top/ducnguyentech/activate-idm-viet-hoa-boi-ducnguyen-software
::
::       Email: contact.ducnguyenwork@gmail.com
::
::========================================================================================================



::  De kich hoat, hay chay tap lenh voi "/act" hoac thay doi 0 thanh 1 o dong ben duoi
set _activate=0

::  De dong bang thoi gian dung thu, hay chay tap lenh voi "/frz" hoac thay doi 0 thanh 1 o dong ben duoi
set _freeze=0

::  De thiet lap lai kich hoat va dung thu, hay chay tap lenh voi "/res" hoac thay doi 0 thanh 1 o dong ben duoi
set _reset=0

::  Neu gia tri duoc thay doi trong cac dong tren hoac su dung lenh thi tap lenh se chay o che do khong giam sat
...
cls
color 07
title  IDM Activation Script %iasver% - Viet Hoa By DucNguyen Tech %dntver%
...
echo:
echo:
call :_color2 %_White% "                 " %_Yellow% "IAS %iasver% - Viet Hoa By DucNguyen Tech %dntver%"  
call :_color2 %_White% "                  " %Green% "Tap lenh nay HOAT DONG voi IDM moi nhat!!!"
...
ECHO @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
ECHO @
ECHO @ IAS 1.2 - Viet Hoa By DucNguyen Tech %dntver%
...
attrib -r %WINDIR%\system32\drivers\etc\hosts
	    ...
	    IF !ERRORLEVEL! NEQ 0 (
	    	ECHO Khong tim thay dong, tu dong them vao file hosts.
	    	ECHO !BLOCKLINE!>>%WINDIR%\system32\drivers\etc\hosts
	    ) ELSE (
	    	ECHO Da tim thay dong.
	    )
    	ECHO.
...
netsh advfirewall firewall add rule name="Block IDM" dir=out action=block remoteip=184.173.188.106
netsh advfirewall firewall add rule name="Block IDM" dir=out action=block remoteip=184.173.188.107
netsh advfirewall firewall add rule name="Idman.exe" dir=in program="%HomeDrive%\Program Files\Internet Download Manager" action=block
netsh advfirewall firewall add rule name="Idman.exe" dir=in program="%HomeDrive%\Program Files (x86)\Internet Download Manager" action=block
