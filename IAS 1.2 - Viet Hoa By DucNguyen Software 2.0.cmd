...
ECHO @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
ECHO @
ECHO @ IAS 1.2 - Viet Hoa By DucNguyen Software 2.0
ECHO @ Block Host IDM
ECHO @
ECHO @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
...
cls
color 07
title  IDM Activation Script %iasver% - Viet Hoa By DucNguyen Software 2.0
...
echo:
echo:
call :_color2 %_White% "               " %_Yellow% "IAS %iasver% - Viet Hoa By DucNguyen Software 2.0"  
